...
- `c_image_label(c_widget *p_parent = nullptr)`  `c_image_label(string path, c_widget *p_parent = nullptr)`  `c_image_label(c_image *image = nullptr, c_widget *p_parent = nullptr)`  `c_image_label(c_tileset *image, c_widget *p_parent = nullptr)`
