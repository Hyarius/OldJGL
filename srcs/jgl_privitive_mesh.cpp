...
namespace jgl
{
	...
	Mesh* primitive_voxel(Vector3 pos, Tileset* tileset, size_t type, float p_transparency, bool should_bake, Vector3 rot, Vector3 size)
	{
		...
		// FACE FRONT
		result->add_face(Face(new int[3]{ 5, 1, 4 }, new int[3]{ 6, 5, 7 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));
		result->add_face(Face(new int[3]{ 0, 4, 1 }, new int[3]{ 4, 7, 5 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));

		// FACE BACK
		result->add_face(Face(new int[3]{ 6, 7, 2 }, new int[3]{ 6, 5, 7 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));
		result->add_face(Face(new int[3]{ 3, 2, 7 }, new int[3]{ 4, 7, 5 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));

		// FACE RIGHT
		result->add_face(Face(new int[3]{ 6, 2, 5 }, new int[3]{ 6, 5, 7 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));
		result->add_face(Face(new int[3]{ 1, 5, 2 }, new int[3]{ 4, 7, 5 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));


		// FACE LEFT
		result->add_face(Face(new int[3]{ 7, 4, 3 }, new int[3]{ 6, 5, 7 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));
		result->add_face(Face(new int[3]{ 0, 3, 4 }, new int[3]{ 4, 7, 5 }, new int[3]{ -1, -1, -1 }, Color(150, 150, 150)));
