...
Matrix::Matrix()
{
	value[0][0] = 1;			value[1][0] = 0;				value[2][0] = 0;				value[3][0] = 0;
	value[0][1] = 0;			value[1][1] = 1;				value[2][1] = 0;				value[3][1] = 0;
	value[0][2] = 0;			value[1][2] = 0;				value[2][2] = 1;				value[3][2] = 0;
...
Matrix::Matrix(X_ROTATE, float angle)
{
	...
	value[0][0] = 1.0f; 		value[1][0] = 0.0f;       		value[2][0] = 0.0f;				value[3][0] = 0;
	value[0][1] = 0.0f; 		value[1][1] = cos(radian); 		value[2][1] = sin(radian);		value[3][1] = 0;
	value[0][2] = 0.0f; 		value[1][2] = -sin(radian); 	value[2][2] = cos(radian);		value[3][2] = 0;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 1;
}
...
Matrix::Matrix(Y_ROTATE, float angle)
{
	...
	value[0][0] = cos(radian);	value[1][0] = 0.0f; 			value[2][0] = -sin(radian);		value[3][0] = 0;
	value[0][1] = 0.0f;      	value[1][1] = 1.0f; 			value[2][1] = 0.0f;				value[3][1] = 0;
	value[0][2] = sin(radian);	value[1][2] = 0.0f; 			value[2][2] = cos(radian);		value[3][2] = 0;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 1;
}
...
Matrix::Matrix(Z_ROTATE, float angle)
{
	...
	value[0][0] = cos(radian);	value[1][0] = sin(radian);		value[2][0] = 0.0f;				value[3][0] = 0;
	value[0][1] = -sin(radian);	value[1][1] = cos(radian);		value[2][1] = 0.0f;				value[3][1] = 0;
	value[0][2] = 0.0f; 		value[1][2] = 0.0f; 			value[2][2] = 1.0f;				value[3][2] = 0;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 1;
}
...
{
	value[0][0] = 1.0f;			value[1][0] = 0.0f; 			value[2][0] = 0.0f;				value[3][0] = t_x;
	value[0][1] = 0.0f;			value[1][1] = 1.0f; 			value[2][1] = 0.0f;				value[3][1] = t_y;
	value[0][2] = 0.0f;			value[1][2] = 0.0f; 			value[2][2] = 1.0f;				value[3][2] = t_z;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 3;
}

Matrix::Matrix(SCALE, float t_x, float t_y, float t_z)
{
	value[0][0] = t_x;			value[1][0] = 0.0f; 			value[2][0] = 0.0f;				value[3][0] = 0.0f;
	value[0][1] = 0.0f;			value[1][1] = t_y; 				value[2][1] = 0.0f;				value[3][1] = 0.0f;
	value[0][2] = 0.0f;			value[1][2] = 0.0f; 			value[2][2] = t_z;				value[3][2] = 0.0f;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 3;
}

Matrix::Matrix(TRANSLATION, Vector3 delta)
{
	value[0][0] = 1.0f;			value[1][0] = 0.0f; 			value[2][0] = 0.0f;				value[3][0] = delta.x;
	value[0][1] = 0.0f;			value[1][1] = 1.0f; 			value[2][1] = 0.0f;				value[3][1] = delta.y;
	value[0][2] = 0.0f;			value[1][2] = 0.0f; 			value[2][2] = 1.0f;				value[3][2] = delta.z;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 3;
}

Matrix::Matrix(SCALE, Vector3 delta)
{
	value[0][0] = delta.x;		value[1][0] = 0.0f; 			value[2][0] = 0.0f;				value[3][0] = 0.0f;
	value[0][1] = 0.0f;			value[1][1] = delta.y; 			value[2][1] = 0.0f;				value[3][1] = 0.0f;
	value[0][2] = 0.0f;			value[1][2] = 0.0f; 			value[2][2] = delta.z;			value[3][2] = 0.0f;
	value[0][3] = 0;			value[1][3] = 0;				value[2][3] = 0;				value[3][3] = 3;
}
