...
void				window_initialisation(string program_name)
{
	...
	g_window = SDL_CreateWindow(program_name.c_str(),
	...
	program_color = LoadShaders(	COLOR_SHADER_VERT,	COLOR_SHADER_FRAG);
	program_sprite = LoadShaders(	TEXTURE_SHADER_VERT, TEXTURE_SHADER_FRAG);
