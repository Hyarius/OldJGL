...
namespace jgl
{
	class Check_entry : public Widget
	{
	protected:
	...
	public:
		...
		void 		set_align(Horizontal_alignment p_align) { _entry.set_horizontal_alignment(p_align); }
		void 		set_align(Vertical_alignment p_align) { _entry.set_vertical_alignment(p_align); }
